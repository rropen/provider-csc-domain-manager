...
PROJECT_NAME ?= provider-csc-domain-manager
PROJECT_REPO ?= github.com/rropen/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= rropen/csc-domain-manager
export TERRAFORM_PROVIDER_REPO ?= https://github.com/rropen/terraform-provider-csc-domain-manager
export TERRAFORM_PROVIDER_VERSION ?= 0.1.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-csc-domain-manager
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-csc-domain-manager_v0.1.0
...
xpkg.build.provider-csc-domain-manager: do.build.images
